...
# print(dir)
filepath = os.path.join(dir, r'C:\Users\USER\Downloads\dorsel_vscode\dorsel_vscode\PreProcessing_FeatureExtraction\MexicanHatKernalData')
import numpy  as np
...
dir = os.path.dirname(os.path.realpath(r'C:\Users\USER\Downloads\dorsel_vscode\dorsel_vscode\PreProcessing_FeatureExtraction\MexicanHatKernalData'))
print(dir)
...
@st.cache_resource
def load_model2():
    return tf.keras.models.load_model('main2.h5')  # Replace 'your_model.h5' with your model file
...
if authentication_status:
	...
	if uploaded_image is not None:
		...
		if st.button('Authenticate'):
			...
			# Check if the image has 3 dimensions (RGB)
			if len(imagearray.shape) == 3:
				...
				if predicted_class_probability > 0.05 :
					...
					# st.write(predicted_class_probability)
				else:
					st.error('Authentication failed! Access denied.')
